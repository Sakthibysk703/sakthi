...
uploaded_file = st.file_uploader("pressure_sensor_data", type=["xlsx"])
...
if uploaded_file is not None:
    try:
        ...
        if all(sensor in df.columns for sensor in ["Sensor 1", "Sensor 2", "Sensor 3"]):
            ...
            st.error("❌ Columns 'Sensor 1', 'Sensor 2', and 'Sensor 3' are required.")
